      ...
      <section className="flex flex-col gap-y-10 px-10">
        <article className="flex flex-col justify-center items-center lg:flex-row gap-x-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-y-10 justify-center">
            ...
            <article className="flex gap-2">
                <h1 className="lg:text-xl font-bold text-neutral-500 bg-jaguar-200 px-3 pt-1 pb-[5px] rounded-full">MERN Stack</h1>
            </article >
        ...
        <article className="flex flex-col justify-center items-center lg:flex-row gap-x-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-y-10 justify-center">
            ...
            <article className="flex gap-2">
                <h1 className="lg:text-xl font-bold text-neutral-500 bg-jaguar-200 px-3 pt-1 pb-[5px] rounded-full">C#.NET</h1>
                <h1 className="lg:text-xl font-bold text-neutral-500 bg-jaguar-200 px-3 pt-1 pb-[5px] rounded-full">MS SQL Server</h1>
            </article >
        ...
        <article className="flex flex-col justify-center items-center lg:flex-row gap-x-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-y-10 justify-center">
            ...
            <article className="flex gap-2">
                <h1 className="lg:text-xl font-bold text-neutral-500 bg-jaguar-200 px-3 pt-1 pb-[5px] rounded-full">C#.NET</h1>
                <h1 className="lg:text-xl font-bold text-neutral-500 bg-jaguar-200 px-3 pt-1 pb-[5px] rounded-full">MS Access</h1>
            </article >
            <a className="text-2xl px-14 py-4 bg-jaguar-200 text-white rounded-md font-semibold">Privet</a>
          </div>
        </article>
        <article className="flex flex-col justify-center items-center lg:flex-row gap-x-10">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-y-10 justify-center">
            ...
            <article className="flex gap-2">
                <h1 className="lg:text-xl font-bold text-neutral-500 bg-jaguar-200 px-3 pt-1 pb-[5px] rounded-full">ASP.NET</h1>
                <h1 className="lg:text-xl font-bold text-neutral-500 bg-jaguar-200 px-3 pt-1 pb-[5px] rounded-full">MS SQL Server</h1>
            </article >
